    ...
    <g transform="translate(1400, 60) scale(.9)">
      ...
      <rect x="-20" y="-20" height="585" fill="url(#key_gradient)">
        <xsl:attribute name="width">
          <xsl:value-of select="200 * ceiling(count(/map/portals/portal) div 16.0) + 20" />
        </xsl:attribute>
      </rect>

      <xsl:for-each select="map/portals/portal">
        <xsl:variable name="i"><xsl:number count="map/portals/portal" /></xsl:variable>
    ...
    <g transform="translate(10, 60)">
      ...
      <rect class="toggleButton" x="-50" y="-25" width="100" height="50" />
        ...
        <text class="scale">
          ...
          <tspan x="-40" y="5">Unofficial</tspan>
          <tspan x="-40" y="17">Roads</tspan>
        </text>
        </g>
      </g>
